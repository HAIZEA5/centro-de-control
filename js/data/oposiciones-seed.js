...
const OPOS_SEED = [
  ...
  {
    convocatoria:    'Ayto. Aretxabaleta — TAG',
    organismo: 'Ayto. Aretxabaleta', puesto: 'TAG',
    tipo_proceso: 'concurso-oposicion', req_euskera: true, nivel_euskera: 'PL2', req_titulacion: true,
    perfil:          'YO',
    grupo:           'C1',
    estado:          'EN PROCESO',
    fase:            'Inscripción abierta',
    fecha_apertura:   '2026-06-18',
    fecha_fin_inscr:  '2026-07-16',
    fecha_lista_prov: null,
    fecha_alegaciones:null,
    fecha_lista_def:  null,
    tasa_pagada:     'NO',
    ...
    doc_meritos:     'Tras oposición',
    doc_discap:      'No aplica',
    notas: 'Técnico/a Auxiliar de Gestión (TAG). Ayuntamiento de Aretxabaleta (Gipuzkoa). Concurso-oposición libre. PL2 preceptivo. BOE-A-2026 (18/06/2026). Plazo inscripción hasta 16/07/2026. 📋 Inscripción: solo instancia. Méritos: acreditar tras oposición. DNI + titulación + euskera: al ser seleccionado.',
    url_boe:   'https://www.boe.es',
    meritos_calc: { meses_misma:12, meses_otras:12, meses_priv:0, euskera:'B2',
      cursos:[{nombre:'IT Txartela (IVAP)',horas:80},{nombre:'Internet básico',horas:20},{nombre:'Word 2010 avanzado',horas:40},{nombre:'PowerPoint 2010',horas:20}] },
  },
  {
    convocatoria:    'Mcdd. Uribe Kosta — Administrativo',
    organismo: 'Mcdd. Uribe Kosta', puesto: 'Administrativo',
    tipo_proceso: 'concurso-oposicion', req_euskera: true, nivel_euskera: 'PL2', req_titulacion: true,
    perfil:          'YO',
    grupo:           'C1',
    estado:          'EN SEGUIMIENTO',
    ...
    doc_meritos:     'Tras oposición',
    doc_discap:      'No aplica',
    notas: '3 plazas de Administrativo. Mancomunidad de Uribe Kosta (Bizkaia). PL2 preceptivo. Bases BOB de 30/06/2026. Pendiente publicación en BOE para abrir plazo de instancias. Fuente: opobizkaia.com (jul-2026). Revisar BOE.',
    url_bases: 'https://www.bizkaia.eus/lehendakaritza/Bao_bob/',
    meritos_calc: { meses_misma:12, meses_otras:12, meses_priv:0, euskera:'B2',
      cursos:[{nombre:'IT Txartela (IVAP)',horas:80},{nombre:'Internet básico',horas:20},{nombre:'Word 2010 avanzado',horas:40},{nombre:'PowerPoint 2010',horas:20}] },
  },
];
